...
def calculate_demographic_data(print_data=True):
    ...
    # Question 4: What percentage of people with advanced education make >50K?
    # Advanced education: Bachelors, Masters, or Doctorate
    higher_education = df['education'].isin(['Bachelors', 'Masters', 'Doctorate'])
    higher_education_rich = round((df[higher_education]['salary'] == '>50K').mean() * 100, 1)

    # Question 5: What percentage of people without advanced education make >50K?
    ...
    # Question 7: What percentage of people who work the minimum number of hours per week have a salary of >50K?
